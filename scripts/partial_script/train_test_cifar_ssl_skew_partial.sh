...
time python src/decentralized_ssl_main.py --model=resnet --dataset=cifarssl --gpu=0 --iid=0 --batch_size=256 --local_bs 224 --local_ep 5 --epochs=500 --log_file_name "dir_partial_ssl" \
