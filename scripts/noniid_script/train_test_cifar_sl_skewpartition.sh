...
time python src/decentralized_sl_main.py --model=resnet --dataset=cifar --gpu=0 --iid=0 --batch_size=256 --local_bs 256 --epochs=500 --local_ep 50 --log_file_name "skew_partition_sl"  --log_directory "noniid_scripts" \
