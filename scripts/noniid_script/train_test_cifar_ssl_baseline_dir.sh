...
time python src/baseline_ssl_main.py --model=resnet --dataset=cifarssl --gpu=0 --iid=0 --batch_size=256 --local_bs 256 --epochs=500 --local_ep 50 --log_file_name "dirichlet_alpha"  --log_directory "noniid_scripts" \
