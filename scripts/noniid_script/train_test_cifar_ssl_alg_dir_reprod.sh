...
time python src/decentralized_featarc_ssl_main.py --model=resnet --dataset=cifarssl --gpu=0 --iid=0 --batch_size=256 --local_bs 256 --epochs=500 --local_ep 5 --log_file_name "dirichlet_alpha_alg_repro"  --log_directory "noniid_scripts" \
